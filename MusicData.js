...
class Playlist {
  ...
  getInfo() {
    console.log(
      `The playlist ${this.name} has the following songs: ${this.song1.title} by ${this.song1.artist.name}, ${this.song2.title} by ${this.song2.artist.name}, & ${this.song3.title} by ${this.song3.artist.name}.`
    );
  }
}
